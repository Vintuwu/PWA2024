    ...
    <div>
      <div>
        ...
        <Button
          ...
          icon={<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-send" viewBox="0 0 16 16">
        ...
        {tareasFiltradas.map((tarea) => (
          <li key={tarea.id}>
            ...
            <Button onClick={() => eliminarTarea(tarea.id)}
              icon={<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-x-circle" viewBox="0 0 16 16">
